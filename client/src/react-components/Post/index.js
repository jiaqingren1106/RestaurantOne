...
class Post extends React.Component{
    ...
    constructor(props) {
        ...
        this.users = [this.props.user.username]
        this.state = {value: '', id: this.props.location.state, postImage: [],description:"", title: "", date: "", image:[], reviews:[], userid: "5fcfbd01794cb32eb4a928ec"};
